import { 
    ...
    GET_EMP_HOLIDAY, INS_APPS, GET_EMP_WFH, GET_EMP_LWP, GET_EMP_LEAVE, GET_EMP_OD, GET_EMP_MANUAL, GET_EMP_COFF, GET_EMP_SL
} from '../actions/type';
...
const initialState = {
    ...
    hodpdlist:null, hodcanlist:null, detailhodlist:null, insempdata:null,empleave:null,empod:null,empmanual:null,empcoff:null,empsl:null,
